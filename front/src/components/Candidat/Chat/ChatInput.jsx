...
Ожидаем вас?
   ...
   return (
      <div className="flex p-4 border-t border-gray-300 flex flex-col">
         <textarea         
            type="text"
         ...
         <button
            className="ml-4 px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none mb-4"
